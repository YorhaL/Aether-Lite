use super::support::{
    admin_system_export_provider_config, collect_admin_system_export_provider_endpoint_formats,
    decrypt_admin_system_export_secret, resolve_admin_system_export_key_api_formats,
    ...
    Ok(providers
        ...
        .map(|provider| {
            ...
            AdminSystemConfigProvider {
                ...
                config: admin_system_export_provider_config(provider.config.as_ref()),
